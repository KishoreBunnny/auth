...
export default function Signin({
    ...
    return (
        <div className="flex justify-center items-center w-full h-full bg-neutral-100 text-neutral-900 dark:bg-neutral-900 dark:text-neutral-200  " >
            <div className={`${className} w-[100vw] md:w-[45vw] lg:w-[30vw]  min-h-[100vh] lg:min-h-[70vh] flex flex-col items-center gap-20 py-4 px-6   z-20  lg:rounded-xl  lg:border-1 dark:border-neutral-700/50 border-neutral-300/50  `} >

                <div className="flex flex-col justify-center items-center " >
                    <h1 className="text-2xl font-bold tracking-tight ">Welcome Back To Login</h1>
                ...
                <form onSubmit={handleSubmit} className=" w-full py-2 px-3 flex flex-col gap-5 ">
                    ...
                    <button type="submit" className="w-full mt-3 font-semibold hover:bg-neutral-200 dark:hover:bg-neutral-700 bg-neutral-300 dark:bg-neutral-800 cursor-pointer  py-2 px-3 flex justify-center items-center gap-1 rounded-lg " >Login<ArrowRright /> </button>
                ...
                <div className="w-full flex flex-col justify-center items-center gap-1 " >
                    ...
                    <div className="mt-1 text-md font-semibold tracking-tighter " >
